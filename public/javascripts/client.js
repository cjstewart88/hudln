(function() {
  ...
  function drawRealm () {
    ...
    $.each(clients, function (client) {
      ...
      if (myY <= 300) {
        realm_context.fillRect(0,0,800,300-myY);
      }
      if (myX <= 800) {
        realm_context.fillRect(0,0,400-myX,600);
      }
      if (myY >= 2500) {
        realm_context.fillRect(0,3310-myY,800,300); 
      }
      if (myX >= 3500) {
        realm_context.fillRect(4410-myX,0,400,600);
      }
